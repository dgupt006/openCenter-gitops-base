locals {
  ...
  openstack_auth_url                      = "https://keystone.api.iad3.rackspacecloud.com/v3/"
  openstack_insecure                      = false
  openstack_region                        = "IAD3"
  ...
  openstack_tenant_name                   = "9065f9b4-7e8e-4cc5-83a9-e4332fd6b7b5"
  floatingip_pool                         = "PUBLICNET"
  router_external_network_id              = "54982148-4c6d-4499-b1b7-ce518df4025e"
  # VLAN settings
  vlan_id                                 = ""
  mtu                                     = ""
  ...
  image_id_windows                        = "2827278b-c8be-44a3-808f-7b310967cb7b"
  k8s_api_port                            = 443
  worker_count                            = 5
  ...
  ssh_authorized_keys                     = ["ssh-rsa  Generated-by-Nova"]
  node_worker                             = "wn"
  node_master                             = "cp"
  ...
  kube_oidc_url                          = "https://auth.dev.iad3.rmpk.dev/realms/opencenter"
...
module "openstack-nova" {
  source = "github.com/opencenter-cloud/openCenter-gitops-base.git//iac/cloud/openstack/openstack-nova?ref=2026.01"
...
module "kubespray-cluster" {
  source = "github.com/opencenter-cloud/openCenter-gitops-base.git//iac/provider/kubespray?ref=2026.01"
