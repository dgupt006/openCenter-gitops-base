...
kube_oidc_auth: ${kube_oidc_auth_enabled}
...
%{ if kube_oidc_auth_enabled == true ~}
kube_oidc_url: "${kube_oidc_url}"
kube_oidc_client_id: ${kube_oidc_client_id}  
# Optional settings for OIDC
kube_oidc_ca_file: "${kube_oidc_ca_file}"
kube_oidc_username_claim: ${kube_oidc_username_claim} 
...
%{ if vrrp_enabled == true || use_octavia == true ~}
...
kube_service_addresses: ${subnet_services}

# internal network. When used, it will assign IP
# addresses from this range to individual pods.
# This network must be unused in your network infrastructure!
kube_pods_subnet: ${subnet_pods}
...
kube_apiserver_port: ${k8s_api_port}  # (https)

# The eviction timeout period, defaults to 300 seconds.
kube_apiserver_pod_eviction_not_ready_timeout_seconds: 120
kube_apiserver_pod_eviction_unreachable_timeout_seconds: 120
...
# Allows binding metrics outside localhost so prometheus can properly scrape the services
